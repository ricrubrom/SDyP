...
void *threadf(void *arg)
{
  ...
  ocurrencias += ocurrencias_parcial;
...
int main(int argc, char *argv[])
{
  ...
  printf("Ocurrencias secuencial: %d\n", ocurrencias_sequential);
  ...
  for (t = 2; t <= T; t *= 2)
  {
    ...
    if (ocurrencias == ocurrencias_sequential)
    {
      printf("Ocurrencias correctas\n");
    }
    else
    {
      printf("Ocurrencias incorrectas\n");
    }
  }
