...
case $tipo in
  ...
  2)
    ...
    if $debug; then
      ...
      echo "Con 2 hilos..."
      mpirun --bind-to none -np 2 mpi_pthreads $nro_cuerpos 200 1000 2 -d &> ./n_body_hybrid_2_4.log
      echo "Con 4 hilos..."
      ...
      echo "Ejecutando con 2 maquinas..."
      echo "Con 2 hilos..."
      mpirun --bind-to none -np 2 mpi_pthreads $nro_cuerpos 200 1000 2 &> ./n_body_hybrid_2_4.log
      echo "Con 4 hilos..."
