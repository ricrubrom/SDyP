...
case $tipo in
  ...
  1)
    ...
    if $graficar; then
      ...
      echo "Con 1 hilos..."
      ./n_body_pthread $nro_cuerpos 200 1000 1 
      echo "Con 4 hilos..."
      ./n_body_pthread $nro_cuerpos 200 1000 4
      echo "Con 8 hilos..."
      ./n_body_pthread $nro_cuerpos 200 1000 8
      echo "Con 16 hilos..."
      ./n_body_pthread $nro_cuerpos 200 1000 16
    fi
